		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordermgtnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordermgtnspworkflowuimodule-display": {
								"semanticObject": "ordermgtnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordermgtnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("ordermgtnsp/workflowuimodule")
								}
							}
						}
					}
